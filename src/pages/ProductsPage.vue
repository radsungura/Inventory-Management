...
<template v-slot:top-right>
  <q-btn @click="showAddProductsDialogue=true" color="primary" label="Add Products"/>
</template>
...
const columns = [
  ...
  {name: 'Product ID', align: 'center', label: 'Product ID', field: 'prodID', sortable: false},
  ...
  {name: 'Supplier', label: 'Supplier', field: 'supplier', sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10)},
