<template>
  <q-layout view="lHh lpr lFf">
    <div v-bind:class="{'main': $q.platform.is.desktop, 'mobile_main': $q.platform.is.ipad || $q.platform.is.mobile}"
        ...
        <q-toolbar class="text-h4">
          ...
          <q-tabs v-model="selected_tab" shrink>
            <q-tab :style="[selected_tab == 't_0' ? {backgroundColor: 'green'} : {}]" class="q-mr-sm q-py-xs custom_tab"
                   @click="scrollToElement('id_about_us')" style="width:120px;min-height:auto !important;color: white"
                   label="About us"/>
            <q-tab :style="[selected_tab == 't_1' ? {backgroundColor: 'green'} : {}]" class="q-mr-sm q-py-xs custom_tab"
                   @click="scrollToElement('id_features')" style="width:120px;min-height:auto !important;color: white"
                   label="Features"/>
            <q-tab :style="[selected_tab == 't_2' ? {backgroundColor: 'green'} : {}]" class="q-mr-sm q-py-xs custom_tab"
                   @click="scrollToElement('id_pricing')" style="width:120px;min-height:auto !important;color: white"
                   label="Pricing"/>
            <q-tab :style="[selected_tab == 't_3' ? {backgroundColor: 'green'} : {}]" class="q-mr-sm q-py-xs custom_tab"
                   @click="scrollToElement('id_contactus')" style="width:120px;min-height:auto !important;color: white"
                   label="Contact us"/>
            <q-btn color="white" text-color="black" style="border: 2px solid green;" label="Free trial" glossy href="http://localhost:8020/Dashboard"/>
      ...
      <section>
        <div class="full-height full-width flex flex-center text-center"
          ...
          <div class="">
            <div class="text-h6 text-grey-5">INVENTORY PLUS</div>
            <div class="text-h2 text-grey-5 q-py-sm q-my-md"
                 style="border-top:3px solid #000000;border-bottom: 3px solid #000000;"> Streamline Your Business with InventoryPlus

            </div>
            <div class="text-h6" style="color: #000000;">
              STOCK CONTROL | LEAD GENERATION | SUPPLIERS QUEQUE
            </div>
    ...
    <div style="background-color:#33495e" >
      <div class="row">
        <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">

          <div style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div >
              <img src= "/Images/Logo.jpg" style="height:500px"
                   class="q-ml-sm"
        ...
        <div class="col-md-8 col-lg-8 col-xs-12 col-sm-12 q-px-md q-pt-sm">
          <div class="text-h4 text-center text-grey-5 q-py-xs q-my-xs"
               style="border-top:3px solid #bdbdbd;border-bottom: 3px solid #bdbdbd;" id="id_about_us"> What is Inventory Plus?
          </div>
          <h5 class="q-my-none text-caption" style="color: #20ffff;">
            Inventory Plus is your one-stop solution for streamlined inventory management. Our intuitive software empowers businesses of all sizes to efficiently track, manage, and optimize their stock levels.
            ...
            Customer order history and analysis
            <br>
            <br>
            Why Choose Us?
            <br>
            Enhanced Efficiency: Streamline your inventory processes and reduce manual errors. <br>
            Improved Accuracy: Maintain accurate stock levels and prevent stockouts or overstocking.<br>
            Data-Driven Decisions: Make informed decisions based on real-time inventory data and analytics.<br>
            Scalability: Our software grows with your business, accommodating your evolving needs.<br>
            Excellent Support: Our dedicated team provides expert assistance and support.<br>
            Join the countless businesses that have streamlined their operations with Inventory Plus
            <br>
            <br>
    ...
    <div style="background-color:#2b5873" id="id_projects">
      <div class="row q-px-xl">
        <div class="text-h4 text-center text-white q-py-sm q-my-md full-width"
             style="border-top:3px solid #bdbdbd;border-bottom: 3px solid #bdbdbd;" id="id_features"> FEATURES OVERVIEW
        </div>


        <div class="col-md-12 col-md-12 col-xs-12 col-sm-12 q-mb-xl flex flex-center">

          <img src= "/Images/Image 2024-09-11 at 12.54.42 PM.jpeg" style="height:500px"
               class="q-ml-sm"
    ...
    <section id="id_sketches">
      <div style="background-color:#206b73;z-index:0;" class="content">
        <div class="row row q-px-xl">
          <div class="text-h4 text-center text-white q-py-sm q-my-md full-width"
               style="border-top:3px solid #bdbdbd;border-bottom: 3px solid #bdbdbd;">CONTACT US
          </div>
    ...
    <q-toolbar class="flex flex-center text-white" style="background-color: #1c1b21;border-top: 2px solid green"
      ...
      <div class="q-pa-sm q-gutter-sm">
        <q-btn target="_blank" style="border: 2px solid green" round type="a" href="#"
               glossy
               icon=""/>
        <q-btn target="_blank" style="border: 2px solid green" round type="a"
               ...
               glossy
               icon="fab fa-github"/>
        <q-btn style="border: 2px solid green" round type="a" href="#"
               glossy
               icon="email"/>
        <q-btn target="_blank" style="border: 2px solid green;" round type="a"
               href="#"
...
.main {
  ...
  background: url(https://images.unsplash.com/photo-1516617217372-ca29bc8c4001?q=80&w=1937&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D) no-repeat center center fixed;
...
#contact_us {
  background: url(https://images.unsplash.com/photo-1516617217372-ca29bc8c4001?q=80&w=1937&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
  background-size: cover;
